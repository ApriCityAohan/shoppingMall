                ...
                <el-tab-pane label="注册与访问" name="first">
                    ...
                    <el-form-item label="注册类型">
                        <el-radio-group v-model="form.reg_method">
                            <el-radio label="username" border>用户名注册</el-radio>
                ...
                <el-tab-pane label="上传设置" name="second">
                    ...
                    <el-form-item label="空间域名">
                        <el-input
                            ...
                            style="width: 30%"
                        ></el-input>
                        <small class="flex text-gray-500 ml-1">请补全http:// 或 https://</small>
                    </el-form-item>
                </el-tab-pane>
...
const submitSave = () => {
    console.log(form)
    loading.value = true
    updateSysConfig({ ...form, password_encrypt: form.password_encrypt.join(',') })
        .then(res => {
            toast('修改成功')
        })
        .finally(() => {
